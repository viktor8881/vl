...
/**
 * Description of AnalisisCurrency_Mapper
 *
 * @author Viktor
 */
class AnalisisCurrency_Mapper extends Core_Domen_Mapper_Abstract {
    
    protected $_table='analisis_currency';
    ...
    public function addWhereByFilter(\Core_Domen_Filter_Abstract $filter, \Zend_Db_Select $select) {
        ...
        switch (get_class($filter)) {
            case 'AnalisisCurrency_Filter_CurrencyCode':                
